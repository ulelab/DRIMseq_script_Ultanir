...
res_pairwise_pA_sites_with_change_in_usage = left_join(res_pairwise_pA_sites,proportions_pairwise, by = "feature_id")

#combine two-test table with change in usage table
two_step_WT_vs_KO_brain_pA_sites_with_change_in_usage=inner_join(two_stage_padj_pairwise,res_pairwise_pA_sites_with_change_in_usage,by='feature_id')
...
#read in file with poly a coordinates (set path to location of the polyA coordinates file)
polyA_coords=read.csv("/Users/llywelyngriffith/Documents/AZ_postdoc/Simeon/Nobby_APA_analysis/common_atlas/mm10/merged_polya.filteredunique.annotated.csv",header = FALSE)
colnames(polyA_coords)[4]="feature_id"

#combine poly A table with coordinate table and change column names
two_step_WT_vs_KO_brain_pA_sites_with_change_in_usage_with_coords = inner_join(two_step_WT_vs_KO_brain_pA_sites_with_change_in_usage,polyA_coords, by = "feature_id")
colnames(two_step_WT_vs_KO_brain_pA_sites_with_change_in_usage_with_coords)[22] = 'chr'
colnames(two_step_WT_vs_KO_brain_pA_sites_with_change_in_usage_with_coords)[23] = 'start'
colnames(two_step_WT_vs_KO_brain_pA_sites_with_change_in_usage_with_coords)[24] = 'end'
colnames(two_step_WT_vs_KO_brain_pA_sites_with_change_in_usage_with_coords)[26] = 'strand'
two_step_WT_vs_KO_brain_pA_sites_with_change_in_usage_with_coords = two_step_WT_vs_KO_brain_pA_sites_with_change_in_usage_with_coords[,-c(5,10,25,27:29)]
...
two_step_WT_vs_HOM_pA_sites_with_change_in_usage=inner_join(two_stage_padj_pairwise,res_pairwise_pA_sites_with_change_in_usage,by='feature_id')
...
colnames(two_step_WT_vs_HOM_pA_sites_with_change_in_usage_with_coords)[22] = 'chr'
colnames(two_step_WT_vs_HOM_pA_sites_with_change_in_usage_with_coords)[23] = 'start'
colnames(two_step_WT_vs_HOM_pA_sites_with_change_in_usage_with_coords)[24] = 'end'
colnames(two_step_WT_vs_HOM_pA_sites_with_change_in_usage_with_coords)[26] = 'strand'
two_step_WT_vs_HOM_pA_sites_with_change_in_usage_with_coords = two_step_WT_vs_HOM_pA_sites_with_change_in_usage_with_coords[,-c(5,10,25,27:29)]
View(two_step_WT_vs_HOM_pA_sites_with_change_in_usage_with_coords)
#write to file
